...
- 사용한 기술과 구현한 기능
  ...
  - 그림판 캔버스 초기화 기능 구현
  - 이미지 파일 저장 기능 구현
  - 외부 이미지 파일을 읽어 캔버스로 사용하도록 구현
  - 이미지 크기에 맞춰 캔버스 크기 조정
  - 이미지 크기가 큰 경우 스크롤바를 통해 이동 가능
  - 확대/축소 기능 구현
...
![과제4 실행 화면](img/그림판4-2.png)
![과제4 실행 화면](img/그림판4-3.png)
![과제4 실행 화면](img/그림판4-4.png)
...
- 구현 내용과 기능 설명
  - 외부 이미지 파일을 읽어 캔버스로 사용하도록 구현했습니다.
  - 이미지 크기에 맞춰 캔버스 크기를 조정했습니다.
  - 이미지 크기가 큰 경우 스크롤바를 통해 이동할 수 있도록 구현했습니다.
  - 확대/축소 기능을 구현하여 이미지 크기를 조절할 수 있도록 했습니다.
